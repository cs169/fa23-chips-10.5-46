...
Rails.application.routes.draw do
    ...
    get '/campaign_finances/search' => 'campaign_finances#search', as: :campaign_finances_search
    ...
    get '/path-to-show-by-county/:name', to: 'representatives#show_by_county', as: 'show_by_county'
